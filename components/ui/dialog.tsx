...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn('text-lg font-heading font-semibold text-white', className)} {...props} />
))
